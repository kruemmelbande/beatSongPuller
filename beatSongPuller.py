...
songs = []
for root, dirs, files in os.walk("QuestMaps"):
    for file in files:
...
for song in songs:
    try:
        ...
        dst_path = os.path.join(".\\Playlist", f"{song[1]} - {song[2]}.egg")
